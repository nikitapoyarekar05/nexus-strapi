...
} from "./chunk-XZLBKMM3.js";
import {
  useTypedSelector
} from "./chunk-6K7BRVH6.js";
import {
...
import {
  useDocumentActions
} from "./chunk-GSDTBSFL.js";
import {
  buildValidParams,
  useDocument,
  useDocumentLayout
} from "./chunk-6CXMATQM.js";
import {
  PERMISSIONS,
  reducer,
  reducer2
} from "./chunk-OUFC32TO.js";
import {
  pluginId
} from "./chunk-SQLDXQZE.js";
import {
  renderAdmin
} from "./chunk-6BUQVL2F.js";
import {
  useLicenseLimits
} from "./chunk-RXAP6ZRG.js";
import {
  require_omit
...
import {
  useRBAC
} from "./chunk-24UQILRH.js";
import {
  useAdminUsers
} from "./chunk-CIY2EQVF.js";
import {
  ForwardRef$J,
  Page,
  useAPIErrorHandler
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-EOCWKQ5E.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-SNRGO7QU.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-3M6NRWOJ.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-LGT42H2L.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OAUXRJ2J.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-RYV54GKT.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-INV272GX.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-BAVHMWKY.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-ZO4YCZNN.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NBLCMJNY.js");
          return {
...
//# sourceMappingURL=chunk-U6ZH4J4K.js.map
